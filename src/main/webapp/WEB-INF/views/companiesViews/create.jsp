...
<form class="row g-3" method="POST" action="companies/createCompany">
    <div class="col-md-6">
        ...
        <input class="form-control" type="text" name="id" id="id" placeholder="companies/id">
    ...
    <div class="col-md-6">
        ...
        <input class="form-control" type="text" name="name" id="name" placeholder="companies/name">
    ...
    <br/>
        <div class="col-md-6">
            ...
            <input class="form-control" type="text" name="state_code" id="state_code" placeholder="companies/state_code">
    ...
    <div class="col-md-6">
        ...
        <input class="form-control" type="text" name="country" id="country" placeholder="companies/country">
    ...
    <div class="col-md-6">
        ...
        <input class="form-control" type="text" name="info" id="info" placeholder="companies/info">
